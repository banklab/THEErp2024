...
simulate_one_gen_mig_logistic <- function(N_a, N_A, carrying_capacity, decay_rate, sel_coeff, mut_rate, mig_rate_a) {
  ...
  offsp_A <- rpois(1, min(N_A + N_A*(sel_coeff-decay_rate)*(1-N_total/carrying_capacity),N_A)) # slows down to 1 as the carrying capacity is reached
...
# Test the function
print(simulate_one_gen_mig_logistic(N_a=100, N_A=0, carrying_capacity=100, decay_rate=0.1, sel_coeff=0.3, mut_rate=0.1, mig_rate_a=1))
...
output <- simulate_pop_mig_logistic(100,0,100,0.1,0.2,0.001,2,max_gen)
